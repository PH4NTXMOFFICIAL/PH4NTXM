...
case "$VENDOR" in
    lenovo)
        SYS_VENDOR="LENOVO"
        BIOS_VENDOR="LENOVO"
        BIOS_VERSION="R1$((100 + 16#$(get_id "b" 2) % 900))WW"
    ...
    dell)
        ...
        BIOS_VERSION="1.$((10 + 16#$(get_id "b" 2) % 20)).0"
    ...
    hp)
        SYS_VENDOR="HP"
        BIOS_VENDOR="HP"
        BIOS_VERSION="F.$((20 + 16#$(get_id "b" 2) % 80))"
    ...
    asus)
        ...
        BIOS_VERSION="$((200 + 16#$(get_id "b" 2) % 200))"
    ...
    msi)
        ...
        BIOS_VENDOR="American Megatrends Inc."
        BIOS_VERSION="E$((10 + 16#$(get_id "b" 2) % 90))"
    ...
    samsung)
        ...
        BIOS_VENDOR="Samsung"
        BIOS_VERSION="P$((10 + 16#$(get_id "b" 2) % 90))"
    ...
    google)
        ...
        BIOS_VERSION="Google_$(get_id "gb" 8)"
    ...
    sony)
        SYS_VENDOR="Sony"
        BIOS_VENDOR="Sony"
        BIOS_VERSION="V$((10 + 16#$(get_id "b" 2) % 90))"
        FAMILY="vaio"

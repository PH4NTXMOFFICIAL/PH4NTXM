...
case "$FAMILY" in
    thinkpad | latitude | elitebook | lifebook | portege) DISPLAY_CLASS="business" ;;
    modern | swift | galaxybook) DISPLAY_CLASS="consumer" ;;
    zenbook | book | surface | gram | pixelbook) DISPLAY_CLASS="ultrabook" ;;
    macmini) DISPLAY_CLASS="apple_desktop" ;;
    nuc | chronos) DISPLAY_CLASS="desktop" ;;
    x3650) DISPLAY_CLASS="server" ;;
    *) exit 1 ;;
esac

...
case "$VENDOR" in
    lenovo)
        SYS_VENDOR="LENOVO"
        BIOS_VENDOR="LENOVO"
        BIOS_VERSION="R1$((100 + 16#$(get_id "b" 2 "stable") % 900))WW"
        case "$FAMILY" in
            thinkpad)
                ...
                ;;
            ideapad)
                PRODUCT_NAME="IdeaPad 3 15ARE05"
                BOARD_NAME="LNVNB161216"
                ;;
            legion)
                PRODUCT_NAME="Legion 5 15ACH6"
                BOARD_NAME="LNVNB161216"
                ;;
            yoga)
                ...
                ;;
            thinkcentre)
                PRODUCT_NAME="ThinkCentre M720"
                BOARD_NAME="M720"
                ;;
            ideacentre)
                PRODUCT_NAME="IdeaCentre 5"
                BOARD_NAME="LNVNB161216"
                ;;
            thinkstation)
                PRODUCT_NAME="ThinkStation P520"
                BOARD_NAME="1036"
                ;;
            *)
                PRODUCT_NAME="ThinkPad L14"
                BOARD_NAME="20U1"
                ;;
        esac
        ;;
    dell)
        ...
        BIOS_VERSION="1.$((10 + 16#$(get_id "b" 2 "stable") % 20)).0"
        case "$FAMILY" in
            xps)
                PRODUCT_NAME="XPS 13 9380"
                BOARD_NAME="0KTW76"
                ;;
            latitude)
                PRODUCT_NAME="Latitude 5410"
                BOARD_NAME="08H9R4"
                ;;
            precision)
                PRODUCT_NAME="Precision 3541"
                BOARD_NAME="0FH2KX"
                ;;
            inspiron)
                PRODUCT_NAME="Inspiron 5502"
                BOARD_NAME="0XYZ12"
                ;;
            optiplex)
    ...
    hp)
        SYS_VENDOR="HP"
        BIOS_VENDOR="HP"
        BIOS_VERSION="F.$((20 + 16#$(get_id "b" 2 "stable") % 80))"
        case "$FAMILY" in
            elitebook)
            ...
            probook)
                ...
                ;;
            zbook)
                PRODUCT_NAME="HP ZBook Firefly 15"
                BOARD_NAME="89AB"
                ;;
            pavilion)
            ...
            envy)
                ...
                ;;
            prodesk)
                PRODUCT_NAME="HP ProDesk 600 G6"
                BOARD_NAME="8717"
                ;;
            elitedesk)
                ...
                ;;
            eliteone)
                PRODUCT_NAME="HP EliteOne 800 G6"
                BOARD_NAME="8712"
                ;;
            *)
                PRODUCT_NAME="HP 250 G7"
                BOARD_NAME="85A1"
                ;;
        esac
        ;;
    asus)
        ...
        BIOS_VERSION="$((200 + 16#$(get_id "b" 2 "stable") % 200))"
        case "$FAMILY" in
            zenbook)
                PRODUCT_NAME="ZenBook UX425EA"
                BOARD_NAME="UX425EA"
                ;;
            vivobook)
                PRODUCT_NAME="VivoBook 15 M513"
                BOARD_NAME="M513UA"
                ;;
            tuf)
                PRODUCT_NAME="TUF Gaming A15"
                BOARD_NAME="FA506"
                ;;
            rog)
                PRODUCT_NAME="ROG Strix G15"
                BOARD_NAME="G513"
                ;;
            expertbook)
                PRODUCT_NAME="ExpertBook B1"
                BOARD_NAME="B1400"
                ;;
            chromebook)
                PRODUCT_NAME="ASUS Chromebook Flip"
                BOARD_NAME="C434TA"
                ;;
            proart)
                PRODUCT_NAME="ProArt Studiobook"
                BOARD_NAME="H7604"
                ;;
            *)
    ...
    acer)
        ...
        BIOS_VERSION="V$((100 + 16#$(get_id "b" 2 "stable") % 200))"
        case "$FAMILY" in
            swift)
                PRODUCT_NAME="Swift 3"
                BOARD_NAME="SF314"
                ;;
            aspire)
                PRODUCT_NAME="Aspire 5"
                BOARD_NAME="A515"
                ;;
            predator)
                PRODUCT_NAME="Predator Helios 300"
                BOARD_NAME="PH315"
                ;;
            nitro)
                ...
                ;;
            chromebook)
                PRODUCT_NAME="Acer Chromebook Spin"
                BOARD_NAME="CP713"
                ;;
            veriton)
                ...
                ;;
            travelmate)
                PRODUCT_NAME="TravelMate P6"
                BOARD_NAME="TMP614"
                ;;
            *)
                PRODUCT_NAME="Aspire E15"
                BOARD_NAME="E15"
                ;;
        esac
        ;;
    msi)
        ...
        BIOS_VENDOR="American Megatrends Inc."
        BIOS_VERSION="E$((10 + 16#$(get_id "b" 2 "stable") % 90))"
        case "$FAMILY" in
            prestige)
                PRODUCT_NAME="Prestige 14"
                BOARD_NAME="MS-14"
                ;;
            modern)
                PRODUCT_NAME="Modern 15"
                BOARD_NAME="MS-15"
                ;;
            summit)
                PRODUCT_NAME="Summit E16"
                BOARD_NAME="MS-1592"
                ;;
            stealth)
                PRODUCT_NAME="GS66 Stealth"
                BOARD_NAME="MS-16"
                ;;
            titan)
                PRODUCT_NAME="GT77 Titan"
                BOARD_NAME="MS-17"
                ;;
            katana)
                PRODUCT_NAME="Katana GF66"
                BOARD_NAME="MS-1581"
                ;;
            gf63)
                PRODUCT_NAME="GF63 Thin"
                BOARD_NAME="MS-16R6"
                ;;
            *)
    ...
    razer)
        ...
        case "$FAMILY" in
            book)
                ...
                BOARD_NAME="RZ09-0357"
                ;;
            *)
                PRODUCT_NAME="Blade 15"
                BOARD_NAME="RZ09-$(get_id "rz" 4 "stable")"
                ;;
        esac
        ;;
    fujitsu)
        ...
        case "$FAMILY" in
            lifebook)
                PRODUCT_NAME="Lifebook U7410"
                BOARD_NAME="FJNB2D5"
                ;;
            esprimo)
                PRODUCT_NAME="Esprimo Q7010"
                BOARD_NAME="D3823"
                ;;
            *)
                PRODUCT_NAME="Fujitsu Device"
                BOARD_NAME="FJNBXXX"
                ;;
        esac
        ;;
    toshiba)
        ...
        case "$FAMILY" in
            satellite)
                PRODUCT_NAME="Satellite Pro C50"
                BOARD_NAME="SY10"
                ;;
            tecra)
                PRODUCT_NAME="Tecra A50"
                BOARD_NAME="SY12"
                ;;
            portege)
                PRODUCT_NAME="Portege X30W"
                BOARD_NAME="SY11"
                ;;
            dynabook)
                PRODUCT_NAME="Dynabook B65"
                BOARD_NAME="DB65"
                ;;
            *)
                PRODUCT_NAME="Toshiba Device"
                BOARD_NAME="SYXX"
                ;;
        esac
        ;;
    samsung)
        ...
        BIOS_VENDOR="Samsung"
        BIOS_VERSION="P$((10 + 16#$(get_id "b" 2 "stable") % 90))"
        case "$FAMILY" in
            galaxybook)
                PRODUCT_NAME="Galaxy Book Pro"
                BOARD_NAME="NP950"
                ;;
            notebook)
                PRODUCT_NAME="Notebook 9"
                BOARD_NAME="NP900"
                ;;
            odyssey)
                PRODUCT_NAME="Notebook Odyssey Z"
                BOARD_NAME="NP850"
                ;;
            chromebook)
                PRODUCT_NAME="Samsung Chromebook 4"
                BOARD_NAME="XE310"
                ;;
            flash)
                PRODUCT_NAME="Notebook Flash"
                BOARD_NAME="NT530"
                ;;
            *)
    ...
    apple)
        ...
        BIOS_VERSION="$((1000 + 16#$(get_id "b" 2 "stable") % 2000)).$((50 + 16#$(get_id "b" 1 "stable") % 50)).$((5 + 16#$(get_id "b" 1 "stable") % 10))"
        case "$FAMILY" in
            macbook)
                case "${SKU,,}" in
                    *-m2*)
                        PRODUCT_NAME="Mac14,7"
                        BOARD_NAME="Mac-827FAC58A8FDFA22"
                        ;;
                    *-m1*)
                        PRODUCT_NAME="MacBookPro17,1"
                        BOARD_NAME="Mac-189A3D4F975D5FFC"
                        ;;
                    *-16-2021*)
                        PRODUCT_NAME="MacBookPro18,1"
                        BOARD_NAME="Mac-EE2EBD4B90B839A8"
                        ;;
                    *air-2020*)
                        PRODUCT_NAME="MacBookAir9,1"
                        BOARD_NAME="Mac-0CFF9C7C2B63DF8D"
                        ;;
                    *)
                        PRODUCT_NAME="MacBookPro16,1"
                        BOARD_NAME="Mac-E1008331FDC96864"
                        ;;
                esac
                ;;
            imac)
                case "${SKU,,}" in
                    *pro*)
                        ...
                        BOARD_NAME="Mac-7BA5B2D9E42DDD94"
                        ;;
                    *)
                        PRODUCT_NAME="iMac20,1"
                        BOARD_NAME="Mac-CFF7D910A743CAAF"
                        ;;
                esac
                ;;
            macmini)
                case "${SKU,,}" in
                    *-m1*)
                        PRODUCT_NAME="Macmini9,1"
                        BOARD_NAME="Mac-7BA5B2D9E42DDD94"
                        ;;
                    *)
                        PRODUCT_NAME="Macmini8,1"
                        BOARD_NAME="Mac-7BA5B2DFE22DDD8C"
                        ;;
                esac
                ;;
            mac-studio)
                PRODUCT_NAME="Mac13,1"
                BOARD_NAME="Mac-7BA5B2D9E42DDD94"
                ;;
            *)
                PRODUCT_NAME="MacBookAir9,1"
                BOARD_NAME="Mac-066C15030E235D5C"
                ;;
        esac
        ;;
    google)
        ...
        BIOS_VERSION="Google_$(get_id "gb" 8 "stable")"
        case "$FAMILY" in
            pixelbook)
                PRODUCT_NAME="Pixelbook Go"
                BOARD_NAME="atlas"
                ;;
            chromebook-pixel)
                ...
                ;;
            pixel-slate)
                PRODUCT_NAME="Pixel Slate"
                BOARD_NAME="nocturne"
                ;;
            *)
                PRODUCT_NAME="Pixelbook"
                BOARD_NAME="eve"
                ;;
        esac
        ;;
    microsoft)
        ...
        BIOS_VERSION="$((100 + 16#$(get_id "b" 2 "stable") % 200))"
        case "${SKU,,}" in
            *surface-pro*)
                PRODUCT_NAME="Surface Pro 8"
                BOARD_NAME="Surface_Pro_8"
                ;;
            *surface-go*)
                PRODUCT_NAME="Surface Go 3"
                BOARD_NAME="Surface_Go_3"
                ;;
            *surface-book*)
                PRODUCT_NAME="Surface Book 3"
                BOARD_NAME="Surface_Book_3"
                ;;
            *surface-studio*)
                PRODUCT_NAME="Surface Studio 2"
                BOARD_NAME="Surface_Studio_2"
                ;;
            *surface-laptop-go*)
                PRODUCT_NAME="Surface Laptop Go"
                BOARD_NAME="Surface_Laptop_Go"
                ;;
            *)
                PRODUCT_NAME="Surface Laptop 4"
                BOARD_NAME="Surface_Laptop_4"
                ;;
        esac
        ;;
    lg)
        SYS_VENDOR="LG Electronics"
        BIOS_VENDOR="LG Electronics"
        BIOS_VERSION="V$((100 + 16#$(get_id "b" 2 "stable") % 200))"
        case "$FAMILY" in
            ultra-gear)
                PRODUCT_NAME="LG UltraGear 17"
                BOARD_NAME="17G90Q"
                ;;
            allinone)
                PRODUCT_NAME="LG All-in-One 24V50N"
                BOARD_NAME="24V50N"
                ;;
            *)
    ...
    ibm)
        ...
        case "$FAMILY" in
            thinkcentre)
                PRODUCT_NAME="ThinkCentre M920s"
                BOARD_NAME="10SJ"
                ;;
            thinkstation)
                PRODUCT_NAME="ThinkStation P330"
                BOARD_NAME="10SC"
                ;;
            x3550 | x3650)
                PRODUCT_NAME="System x Server"
                BOARD_NAME="IBM-SERVER"
                ;;
            *)
                PRODUCT_NAME="ThinkPad X60"
                BOARD_NAME="1706"
                ;;
        esac
        ;;
    ...
    sony)
        SYS_VENDOR="Sony"
        BIOS_VENDOR="Sony"
        BIOS_VERSION="V$((10 + 16#$(get_id "b" 2 "stable") % 90))"
        case "$FAMILY" in
            vaio)
    ...
    *)
        ...
        BIOS_VENDOR="Generic"
        BIOS_VERSION="1.$((10 + 16#$(get_id "b" 2 "stable") % 20)).0"
        PRODUCT_NAME="PC-$(get_id "gen" 4 "stable")"
        BOARD_NAME="GENERIC"
        ;;
esac

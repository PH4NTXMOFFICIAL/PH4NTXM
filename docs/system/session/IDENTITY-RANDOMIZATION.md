...
New physical adapters use the separate hotplug helper, which derives and verifies their protected session address before release. Lone Wolf has its own identity implementation.

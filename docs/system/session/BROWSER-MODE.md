...
In Lone Wolf, verifies the Tor Browser files against the installed manifest before publishing readiness and records the manifest hash under `/run/ph4ntxm/tor-browser-verified`.
